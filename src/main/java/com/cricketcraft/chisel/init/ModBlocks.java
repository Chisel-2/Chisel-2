	...
	public static void load() {
		...
		if (Configurations.featureEnabled("marble")) {
			...
			if (Configurations.featureEnabled("marblePillar")) {
				if (Configurations.oldPillars) {
					marblePillar = (BlockCarvable) new BlockCarvable(Material.rock).setCreativeTab(ModTabs.tabStoneChiselBlocks).setHardness(2.0F).setResistance(10F)
					...
					marblePillar = (BlockCarvable) new BlockMarblePillar(Material.rock).setCreativeTab(ModTabs.tabStoneChiselBlocks).setHardness(2.0F).setResistance(10F)
							.setStepSound(Block.soundTypeStone);
					marblePillar.carverHelper.setChiselBlockName("Marble Pillar");
				...
				marblePillarSlab = (BlockMarbleSlab) new BlockMarbleSlab(marblePillar).setCreativeTab(ModTabs.tabStoneChiselBlocks).setHardness(2.0F).setResistance(10F)
						.setStepSound(Block.soundTypeStone);
		...
		if (Configurations.featureEnabled("packedice")) {
			...
			if (Configurations.featureEnabled("packedicePillar")) {
				packedicePillar = (BlockMarblePackedIce) new BlockMarblePackedIce().setCreativeTab(ModTabs.tabOtherChiselBlocks).setHardness(0.5F).setLightOpacity(3)
		...
		if (Configurations.featureEnabled("redstoneBlock")) {
			redstone = (BlockCarvablePowered) (new BlockCarvablePowered(Material.iron)).setCreativeTab(ModTabs.tabOtherChiselBlocks).setHardness(5.0F).setResistance(10.0F)
		...
		if (Configurations.featureEnabled("holystone")) {
			holystone = (BlockHolystone) new BlockHolystone(Material.rock).setCreativeTab(ModTabs.tabStoneChiselBlocks).setHardness(2.0F).setResistance(10F)
		...
		if (Configurations.featureEnabled("carpetFloor")) {
			carpetFloor = (BlockMarbleCarpet) new BlockMarbleCarpet(Material.cloth).setCreativeTab(ModTabs.tabOtherChiselBlocks).setHardness(2.0F).setResistance(10F)
		...
		if (Configurations.featureEnabled("glassStainedPane"))
			for (int i = 0; i < 16; i++) {
				...
				if (glassPrefix == 0) {
					stainedGlassPane[glassId] = (BlockCarvablePane) new BlockCarvablePane(Material.glass, true).setStained(true).setHardness(0.3F).setStepSound(Block.soundTypeGlass)
							.setBlockName("Stained Glass Pane").setCreativeTab(ModTabs.tabOtherChiselBlocks);
		...
		if (Configurations.featureEnabled("pumpkin")) {
			for (int metadata = 0; metadata < 16; metadata++) {
				pumpkin[metadata] = (BlockCarvablePumpkin) new BlockCarvablePumpkin(false).setCreativeTab(ModTabs.tabOtherChiselBlocks).setHardness(1.0F).setBlockName("pumpkin")
		...
		if (Configurations.featureEnabled("jackolantern")) {
			for (int metadata = 0; metadata < 16; metadata++) {
				jackolantern[metadata] = (BlockCarvablePumpkin) new BlockCarvablePumpkin(true).setCreativeTab(ModTabs.tabOtherChiselBlocks).setHardness(1.0F).setBlockName("litpumpkin")
						.setCreativeTab(ModTabs.tabOtherChiselBlocks);
		...
		if (Configurations.featureEnabled("voidstone")) {
			voidstone = (BlockCarvable) new BlockCarvable().setCreativeTab(ModTabs.tabStoneChiselBlocks).setStepSound(Block.soundTypeStone).setCreativeTab(ModTabs.tabStoneChiselBlocks)
			...
			voidstone2 = (BlockMarbleTexturedOre) new BlockMarbleTexturedOre(Material.rock, Chisel.MOD_ID + ":voidstone/animated/void").setStepSound(Block.soundTypeStone)
					.setCreativeTab(ModTabs.tabStoneChiselBlocks).setHardness(5.0F).setResistance(10.0F);
		...
		// 1.8
		if (Configurations.featureEnabled("granite")) {
			granite = (BlockCarvable) new BlockCarvable(Material.rock).setHardness(2.0F).setResistance(10.0F).setCreativeTab(ModTabs.tabStoneChiselBlocks);
		...
		if (Configurations.featureEnabled("diorite")) {
			diorite = (BlockCarvable) new BlockCarvable(Material.rock).setHardness(2.0F).setResistance(10.0F).setCreativeTab(ModTabs.tabStoneChiselBlocks);
		...
		if (Configurations.featureEnabled("andesite")) {
			andesite = (BlockCarvable) new BlockCarvable(Material.rock).setHardness(2.0F).setResistance(10.0F).setCreativeTab(ModTabs.tabStoneChiselBlocks);
