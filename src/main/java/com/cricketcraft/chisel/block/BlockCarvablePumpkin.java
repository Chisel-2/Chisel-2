...
public class BlockCarvablePumpkin extends BlockDirectional implements IBlockWithSubtypes {
	...
	public IBlockState getStateFromMeta(int meta) {
		return this.getDefaultState().withProperty(ChiselProperties.PUMPKINS_VARIANTS, ChiselProperties.PUMPKINS_VARIANTS.fromMeta(meta)).withProperty(FACING, EnumFacing.getFront(meta - ChiselProperties.PUMPKINS_VARIANTS.fromMeta(meta).getMeta()));
	}
