...
public class BlockMossyCobblestone extends BlockCarvable implements IBlockWithSubtypes {
    ...
    protected BlockState createBlockState() {
        return new BlockState(this, ChiselProperties.MOSSY_COBBLESTONE_VARIANTS);
    }
}
