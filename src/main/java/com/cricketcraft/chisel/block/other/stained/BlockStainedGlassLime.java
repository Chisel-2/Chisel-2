...
public class BlockStainedGlassLime extends BlockCarvableGlass implements IBlockWithSubtypes {
    public BlockStainedGlassLime() {
        super();
    ...
    protected BlockState createBlockState() {
        return new BlockState(this, ChiselProperties.STAINED_GLASS_LIME_VARIANTS);
    }
}
