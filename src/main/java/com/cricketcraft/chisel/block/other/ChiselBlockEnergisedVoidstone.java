...
public class ChiselBlockEnergisedVoidstone extends Block implements IChiselBlock {
    ...
    protected BlockState createBlockState() {
        return new BlockState(this, ChiselProperties.ENERGISED_VOIDSTONE_VARIANTS);
    }
}
