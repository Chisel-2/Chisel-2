...
public class BlockStainedGlassPaneBlue extends BlockPane implements IBlockWithSubtypes {
    public BlockStainedGlassPaneBlue() {
    ...
    protected BlockState createBlockState() {
        return new BlockState(this, ChiselProperties.STAINED_GLASS_PANE_BLUE_VARIANTS);
    }
}
