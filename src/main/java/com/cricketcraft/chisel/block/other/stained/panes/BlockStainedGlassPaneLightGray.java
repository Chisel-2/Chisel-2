...
public class BlockStainedGlassPaneLightGray extends BlockPane implements IBlockWithSubtypes {
    public BlockStainedGlassPaneLightGray() {
    ...
    protected BlockState createBlockState() {
        return new BlockState(this, ChiselProperties.STAINED_GLASS_PANE_LIGHT_GRAY_VARIANTS);
    }
}
